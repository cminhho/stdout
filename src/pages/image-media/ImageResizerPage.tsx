      ...
      inputPane={{
        ...
        children: (
          <div className="flex flex-col gap-3 flex-1 min-h-0">
            <div
              className="flex flex-col items-center justify-center border-2 border-dashed border-border rounded-md p-6 cursor-pointer hover:border-primary/50 transition-colors min-h-[200px] flex-shrink-0"
