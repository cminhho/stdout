...
export const tools: ToolDefinition[] = [
    ...
    { id: "html-formatter", path: "/formatters/html", label: "HTML Beautify/Minify/Validate", description: "Beautify, minify & validate HTML", group: "Formatters", icon: "Code2", component: lazy(() => import("@/pages/formatters/HtmlFormatterPage")) },
