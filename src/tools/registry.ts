...
export const tools: ToolDefinition[] = [
  ...
  { id: "hash-generator", path: "/encode/hash", label: "Message Digester", description: "MD5, SHA-1, SHA-256 hashes", group: "Encode & Crypto", icon: "Hash", component: lazy(() => import("@/pages/encode/HashGeneratorPage")) },
  ...
  { id: "credit-card", path: "/validators/credit-card", label: "Credit Card Generator & Validator", description: "Luhn check and generate test card numbers", group: "Validators", icon: "KeyRound", component: lazy(() => import("@/pages/validators/CreditCardPage")) },
  ...
  { id: "cron-parser", path: "/validators/cron", label: "Cron Parser", description: "Build and parse cron expressions (Quartz-style)", group: "Validators", icon: "Clock", component: lazy(() => import("@/pages/validators/CronBuilderPage")) },
  ...
  { id: "mime-types", path: "/web/mime-types", label: "List of MIME Types", description: "Reference table of common MIME types", group: "Web Resources", icon: "FileText", component: lazy(() => import("@/pages/web-resources/MimeTypesPage")) },
