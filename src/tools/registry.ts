...
export const tools: ToolDefinition[] = [
    ...
    { id: "regex-tester", path: "/text/regex", label: "Regex Tester", description: "Test regular expressions with live matching (JS engine; Java-style \\ escapes supported)", group: "Validators", icon: "Regex", component: lazy(() => import("@/pages/validators/RegexTesterPage")) },
